...
ICECAST_PUSH = "icecast://source:hackme@127.0.0.1:8000/live.mp3"
...
def start_stream():
    ...
    -f mp3 \
    icecast://source:hackme@127.0.0.1:8000/live.mp3
    """
...
def api_status():
    return jsonify({
        ...
        "stream": ICECAST_URL,
        "stream_process_running": stream_process is not None and stream_process.poll() is None,
    })
